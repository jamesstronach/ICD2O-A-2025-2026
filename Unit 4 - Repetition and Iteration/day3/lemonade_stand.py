...
# need to incorporate signs into the equasion
    if weather == "Sunny" and glass_price <= 18:
        ...
        glasses_sold = #(80 - 100%) of glasses and don't just make it percentage because what if they make like 2 glasses, they're gonna sell out ofc
